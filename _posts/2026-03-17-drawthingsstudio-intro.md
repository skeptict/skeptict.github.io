...
- **Image Inspector** — drag any PNG onto it and instantly see every generation parameter that produced it. Works with Draw Things, A1111, and ComfyUI images.
...
- **Workflow Builder** — build and run StoryFlow instruction sequences visually, without touching JavaScript.
- **Story Studio** — create multi-scene visual narratives with consistent characters, settings, and styles across every image.
...
DrawThingsStudio is available on GitHub at [skeptict/DrawThingsStudio](https://github.com/skeptict/DrawThingsStudio). Download the latest release, unzip it, and drag it to your Applications folder. That's it.
...
First up: the Image Inspector, which is honestly the fastest way to fall in love with the app.

---

*Have questions, bugs, or feature ideas? Open an issue on GitHub — I read every one.*
